...
public class DoctorPayloadBuilder {
  ...
  private static final String INITIAL_PASSWORD = "Doctor@1234!";
  private static final List<String> DEPARTMENTS =
      Arrays.asList("Primary Care", "Cardiology", "Dermatology", "Pediatrics", "Oncology");
  ...
  public static String build() {
    ...
    return String.format(
        "{ \"firstName\": \"%s\", "
            ...
            + "\"department\": \"%s\", "
            + "\"initialPassword\": \"%s\" }",
        firstName, lastName, TITLE, specialityId, email, phone, department, INITIAL_PASSWORD);
  }
  ...
  private static String randomPhone() {
    return String.format("+1-%03d-%04d", 100 + random.nextInt(900), 1000 + random.nextInt(9000));
  }
