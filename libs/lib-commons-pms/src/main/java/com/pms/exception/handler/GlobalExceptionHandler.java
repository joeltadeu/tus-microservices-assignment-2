...
public class GlobalExceptionHandler {
  ...
  @ResponseBody
  public ResponseEntity<ExceptionResponse> authorizationDeniedException(AuthorizationDeniedException e) {
    ExceptionResponse err = new ExceptionResponse(HttpStatus.UNAUTHORIZED, e.getMessage());
    return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(err);
  }
  ...
  public ResponseEntity<ExceptionResponse> serviceUnavailableException(
    ...
    ExceptionResponse err = new ExceptionResponse(HttpStatus.SERVICE_UNAVAILABLE, e.getMessage());
